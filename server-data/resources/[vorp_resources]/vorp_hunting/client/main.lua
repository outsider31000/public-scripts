...
function sellAnimal() -- Selling animal function
    ...
    if horse ~= nil or horse ~= false and 10 >= dist then 
        ...
        if Citizen.InvokeNative(0x0CEEB6F4780B1F2F,horse,0) ~= false and 10 >= dist then
               ...
               if 2 > dist then 
                    ...
                    if holding ~= false and Config.Animals[model] == nil then
                        if Config.maxpelts > keys(peltz) then
                            ...
                            if IsControlJustPressed(2, 0xE30CD707) then
