...
INSERT INTO `items` (`item`, `label`, `limit`, `can_remove`, `type`, `usable`) VALUES ('p_baitCheese01x', 'Chese Bait', '10', '1', 'item_standard', '1');
...
INSERT INTO `items` (`item`, `label`, `limit`, `can_remove`, `type`, `usable`) VALUES ('p_finishedragonflylegendary01x', 'Lagendary Dragonfly Lure', '10', '1', 'item_standard', '1');
